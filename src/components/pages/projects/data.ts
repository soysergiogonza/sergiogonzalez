...
export const data: Projects[] = [
  {
    ...
    image: "/todo-app.png",
    description:
      "The idea of this application is to learn About how can i work with an specific Architecture, building Designs and Diagrams about this Todo App",
    urlGitHub: "",
    urlPreview: "https://todo-app.sergiogonzalez.tech/",
    stack: ["React", "TypeScript", "NextJS", "ChakraUI"],
  },
  {
  ...
  },
  {
    ...
    image: "/elisa.svg",
    description:
      "Elisa Portfolio is a project that showcases my web development skills and knowledge. I used Flexbox CSS to create an attractive and responsive design.",
